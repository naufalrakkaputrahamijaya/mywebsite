...
if(typeof klasemenDetail === 'undefined'){
    var klasemenDetail = [
      { name: 'Geo Kusala', tugas: [64, 89.1, 83.95, 1,83.02] },
      { name: 'Aero Netra', tugas: [55, 86.8, 79.71, 1, 85.30] },
      { name: 'Jalacise', tugas: [66, 90.9, 88.17, 1, 79.82] },
      { name: 'Vajra Vium', tugas: [92, 87.9, 82.04, 1, 86.72] },
      { name: 'Dhatu Stream', tugas: [47, 86.3, 78.56, 1, 87.70] },
      { name: 'Infra Luhita', tugas: [68, 81.4, 76.12, 2, 78.93] },
      { name: 'Loka Map', tugas: [82, 85.6, 79.76, 1, 79.93] },
      { name: 'Nira Nautika', tugas: [58, 91.15, 86.76, 1, 86.86] },
      { name: 'Giridera', tugas: [52, 89.35, 80.71, 1, 86.01] }
    ];
}
